        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-400 mb-6 max-w-md">
              Transforming brands through powerful storytelling and innovative advertising solutions 
              for television, theatre, and social media.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <button onClick={() => document.getElementById('portfolio')?.scrollIntoView({ behavior: 'smooth' })} className="text-gray-400 hover:text-white transition-colors">
                  Portfolio
                </button>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="text-gray-400">Television Commercials</li>
              <li className="text-gray-400">Theatre Advertising</li>
